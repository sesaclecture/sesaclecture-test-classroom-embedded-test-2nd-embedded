...
def check_uboot_aarch64(uboot_src: str) -> Dict[str, object]:
    ...
    # defconfig
    _run(["make", "rpi_arm64_defconfig"], cwd=uboot_src)

    # build
    build = _run(
        ["bash", "-lc", "make -j$(nproc) CROSS_COMPILE=aarch64-linux-gnu-"],
        cwd=uboot_src,
    )
    ...
    f = _run(["file", "u-boot"], cwd=uboot_src)
    file_out = (
...
if __name__ == "__main__":
    ...
    print(check_uboot_aarch64("/home/jcrt/code_test/gitlab/kcci/u-boot"))
